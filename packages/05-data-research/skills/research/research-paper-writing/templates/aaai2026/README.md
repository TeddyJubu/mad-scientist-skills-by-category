...
> **📝 / Important Notice**: CursorAAAI 2026。，issues。
> 
...
AAAI 2026（camera-ready）**** `aaai2026-unified-template.tex`。
...
- **Camera-ready**: `\usepackage{aaai2026}`

#### 2. 
- ****: "AAAI Press Anonymous Submission Instructions for Authors Using LaTeX"
- **Camera-ready**: "AAAI Press Formatting Instructions for Authors Using LaTeX --- A Guide"
...
#### 
`aaai2026-unified-supp.tex` AAAI 2026，。
...
****:
- [ ] `\def\aaaianonymous{true}` (camera-ready)
- [ ] 
- [ ] 
- [ ] 
...
⚠️ **Bibliography Style**:
- `aaai2026.sty``\bibliographystyle{aaai2026}`
...
#### 1. "Illegal, another \bibstyle command"
****: bibliography style 
****: `\bibliographystyle{aaai2026}`，`aaai2026.sty`

#### 2. 
****: natbibBibTeX 
****: LaTeX：pdflatex → bibtex → pdflatex → pdflatex
