...
**ALWAYS paste the complete repurposed content directly in the Telegram chat response.**
Do not just save files — the user copies/pastes from the chat. Include all 10 formats
with clear section headers. Save files to workspace as a backup, but the in-chat delivery
